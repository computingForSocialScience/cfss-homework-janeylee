...
create_commute = """CREATE TABLE IF NOT EXISTS commute (
	geoID VARCHAR (128),
	Fips VARCHAR (128),
	B08393001 VARCHAR(128),
	B08393002 VARCHAR(128), 
	B08393003 VARCHAR(128), 
	B08393004 VARCHAR(128),
	B08393005 VARCHAR(128),  
	B08393006 VARCHAR(128),
	B08393007 VARCHAR(128),  
	B08393008 VARCHAR(128), 
	B08393009 VARCHAR(128), 
	B08393010 VARCHAR(128), 
	B08393011 VARCHAR(128), 
	B08393012 VARCHAR(128), 
	B08393013 VARCHAR(128)
         ) ENGINE=MyISAM DEFAULT CHARSET=utf8"""
...
for state in states.keys():
	print "starting state" + state
	insertCommute = '''INSERT INTO commute (geoID, Fips, B08393001, B08393002, B08393003, B08393004, 
		B08393005, B08393006, B08393007, B08393008, B08393009, B08393010, B08393011, 
		B08393012, B08393013) VALUES (%s, %s, %s, %s, %s, %s,  %s, %s, %s, %s, %s, %s, %s, %s, %s)''' 
